  ...
  if(redirect){
    ...
    return (
        ...
        <form onSubmit={savePlace}>
          {preInput('Title' , 'Title for your place, preferably short and catchy' )}
          <input
            type="text" value={title} onChange={ev => setTitle(ev.target.value)}
            placeholder="for example : Villa Royal Greens"
          />
          ...
          {preInput('Check in & out times, max guests' , 'Add check in and check out times, remember to have some tinme window for cleaning and room between guests' )}
